...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url()?>assets/front/global/plugins/clockface/css/clockface.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo base_url();?>assets/front/global/plugins/multi-file-upload/jquery.fileupload.js"></script>
        ...
        <script src="<?php echo base_url()?>assets/front/pages/scripts/components-date-time-pickers.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url()?>assets/front/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
         ...
         <link href="<?php echo base_url();?>assets/front/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css" 
         rel="stylesheet" type="text/css" />
		<script src="<?php echo base_url();?>assets/front/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" 
