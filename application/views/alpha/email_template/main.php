...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td bgcolor="#ffffff" align="center" style="padding: 10px 10px 10px 10px;" class="section-padding">
            <table border="0" cellpadding="0" cellspacing="0" width="850" class="responsive-table">
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#eaeaea">
                            <tr>
                                ...
                                <td colspan="2" align="center" style="padding: 10px" >
                                   <img src="<?php echo base_url()?>assets/admin/images/logo/alia-logo.png" alt="photo" width="400" height="110">
                                </td>
