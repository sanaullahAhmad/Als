<div class="page-content">
  <!-- BEGIN PAGE HEADER-->
  <h3 class="page-title"> Update Service
      <small></small>
  </h3>
  <div class="page-bar">
  ...
  <div class="row">
      ...
      <!-- Table -->
        <form id="editservice-form" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select class="form-control" id="category" name="category">
                ...
                $services_categories = $this->General_model->get_data_all('services_categories');
				foreach($services_categories as $category)
				{
					?>
					<option value="<?php echo $category['id'];?>" <?php if($category['id']==$service_cat->category_id){?> selected="selected" <?php }?>><?php echo $category['name'];?></option>
					<?php
				}
				?>
            </select>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
        	...
        	<input type="hidden" id="current_name" name="current_name" value="<?php echo $service_cat->name;?>">
            <button type="submit" id="edit_service_btn" name="edit_service_btn" class="btn btn-primary">Update</button>
        </div>
    </div>
</form>
		 </div>
