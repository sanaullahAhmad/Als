	...
	$("#addfacility-form").validate({
				  rules: {
	                 ...
	                 name: {
	                    required: true,
						  remote: {
						  url: "<?php echo base_url()?>manager/check_facility_in_category_exists/condo_facilities",
						  type: "post",
						  data: {
							  name: function(){ return $("#name").val(); },
							  facility_category: function(){ return $("#facility_category").val(); }
						  }
						  }
	                },
				  ...
				  rules: {
	                 ...
	                 name: {
	                    required: true,
						  ...
						  data: {
							  name: function(){ return $("#name").val(); },
							  saved_name: function(){ return $("#saved_name").val(); },
							  facility_category: function(){ return $("#facility_category").val(); }
						  }
						  }
	                },
