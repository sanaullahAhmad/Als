...
<![endif]-->
        ...
        <script src="<?php echo base_url()?>assets_v1/admin/css/components/bootstrap-timepicker.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>assets/front/global/plugins/multi-file-upload/jquery.ui.widget.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>assets/front/global/plugins/multi-file-upload/jquery.fileupload.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>assets_v1/admin/css/components/common/forms/editors/wysihtml5/assets/lib/js/wysihtml5-0.3.0_rc2.min.js"></script>
        <script src="<?php echo base_url()?>assets_v1/admin/css/components/common/forms/editors/wysihtml5/assets/lib/js/bootstrap-wysihtml5-0.0.2.js"></script>
        <script src="<?php echo base_url()?>assets_v1/admin/css/components/common/forms/editors/wysihtml5/assets/custom/wysihtml5.init.js?v=v1.9.6"></script>
