...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form-manager" id="login-form-manager" action="" method="post">
            	<div id="login-holder">
                ...
                <div class="form-actions">
                    <a href="javascript:;" id="forgot-pass-click" class="forget-password">Forgot Password?</a>
            ...
            <form class="forget-form" id="forgot-pass-form-manager" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <span id="email_forgot_validate" class="error_individual"></span></div>
                <div class="form-actions">
            ...
            <div id="success-message" style="display:none">
                      ...
                      <div>
                        <a href="<?php echo base_url()?>manager" class="btn btn-inverse btn-stroke btn-block">Back to login</a>
