    ...
    <body class=" login">
        ...
        <!--<div class="logo">
            <a href="javascript: void(0)">
                    <img src="<?php echo base_url()?>assets/front/layouts/layout3/img/logo-final.png" alt="" /> </a>
            </div>-->
            <!-- END LOGO -->
            <!-- BEGIN LOGIN FORM -->
            ...
            <form class="register-form2" action="<?php echo base_url()?>signup" method="post" id="addresident-form">
                <div class="form-title">
                <?php if(isset($_GET['email']))
					  { 
					  $code = $this->encrypt_model->decode($_GET['email']);
					  $element = explode(',', $code);
					  }
				?>
                    <span class="form-title">Sign Up | <?php if($element[4]!=""){
			echo $this->General_model->get_value_by_id('condos', $element[4], "name");
		} ?></span>
                </div>
                ...
                <div class="form-group">
                    ...
                    value="<?php  echo $element[0];?>" readonly/>
                ...
                <div class="form-group">
                    ...
                    <select  onChange="change_floors(this.value)" class="form-control" disabled>
                       <option value="<?php echo $element[1];?>">
                          <?php echo $this->General_model->get_value_by_id('blocks',$element[1],'name');?>
                        </option>
                    </select>
                    <input type="hidden" name="block" id="block" value="<?php  echo $element[1];?>">
                    <span class="error_individual" id="block_reg_validate"></span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" disabled>
                       <option value="<?php  echo $element[2];?>">
                          <?php  echo $element[2];?>
                      </option>
                    </select>
                    <input type="hidden" name="floors" id="floors" value="<?php  echo $element[2];?>">
                    <span class="error_individual" id="floors_reg_validate"></span>
                </div>
                
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Unit</label>
                    <select  class="form-control" disabled>
                       <option value="<?php  echo $element[3];?>">
                         <?php  echo $element[3];?>
                      </option>
                    </select>
                    <input type="hidden" name="unit" id="unit" value="<?php  echo $element[3];?>">
                    <span class="error_individual" id="unit_reg_validate"></span>
                </div>
                ...
                <?php //echo $element[4];?>
                    ...
                    <select  class="form-control" disabled>
                       <option value="2" <?php if($element[5]==2){ echo "selected";}?>>
                          Owner
                      </option>
                      <option value="1" <?php if($element[5]==1){ echo "selected";}?>>
                          Tenant
                      </option>
                    </select>
                    <input type="hidden" name="type" id="type" value="<?php  echo $element[5];?>">
                    <span class="error_individual" id="unit_reg_validate"></span>
                </div>
                 ...
                 <div class="form-actions">
                	<p style="text-align:left;">
                    	By logging into ALIA , you agree to our <a style="color:#337ab7!important" href="<?php echo base_url()?>terms_of_use">Terms & Conditions</a> and have read our <a style="color:#337ab7!important" href="<?php echo base_url()?>privacy_policy">Privacy Policy</a>.
                    </p>
                </div>
                
                <div class="form-actions">
<!--                    <button type="button" id="register-back-btn" class="btn btn-default">Back</button>
-->                    <input type="hidden" name="condo_id" value="<?php  echo $element[4];?>">
