...
App.Scripts = {
	...
	plugins_dependency: [
		...
		'<?php echo base_url()?>assets/admin/css/components/plugins/jquery.validate.min.js',
		'<?php echo base_url()?>assets/admin/css/components/plugins/chosen.jquery.min.js',
		'<?php echo base_url()?>assets/admin/css/components/plugins/jquery.multiselect.js',
	...
	plugins: [
		...
		'<?php echo base_url()?>assets/admin/css/components/plugins/jquery.validate.file.js',
		'<?php echo base_url()?>assets/admin/css/components/plugins/ImageSelect.jquery.js',
	...
	<!-- col -->
		...
		<div class="col-separator col-unscrollable box">
			...
			<div class="col-table">
                ...
                <p class="margin-none innerT center"><a href="<?php echo base_url()?>alpha" class="btn btn-warning">Try Forgot Password Option again.</a></p>  
                                         <?php
