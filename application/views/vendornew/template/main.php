...
App.Scripts = {
	...
	'<?php echo base_url()?>assets_v1/admin/css/components/common/tables/datatables/assets/custom/js/DT_bootstrap.js?v=v1.9.6&sv=v0.0.1', 
		
	'<?php echo base_url()?>assets_v1/admin/css/components/plugins/jquery.validate.file.js',
    '<?php echo base_url()?>assets_v1/admin/css/components/plugins/ImageSelect.jquery.js',
	],
	...
	bundle: [
		...
		'<?php echo base_url()?>assets_v1/admin/css/components/common/tables/datatables/assets/custom/js/datatables.init.js?v=v1.9.6&sv=v0.0.1',
