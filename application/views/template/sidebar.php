...
-->    
	...
	//$actual_ad_id = array();
		...
		$sql="SELECT * from advertisements where ad_type='Premium' AND ad_category = '1'  AND (start_date<NOW() AND end_date>NOW()) ORDER BY RAND() "; //LIMIT 2  //Remove limit, no loop will break if 2 advertisement are shown. this to avoid showing less ads due to in_aaray function check
