...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url()?>assets/front/pages/css/contact.min.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo base_url()?>assets/front/global/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
		<?php
        if($this->uri->segment(1)=='advertisements')
		{?>
		<script src="<?php echo base_url()?>assets/front/pages/scripts/portfolio-1-advertisements.js"></script> 
		<?php  } else {?>
