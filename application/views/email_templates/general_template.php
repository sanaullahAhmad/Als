                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000">
                            <tr>
                                ...
                                <td align="center" style="padding: 10px" >
                                    <img class="imglogo" src="<?php echo base_url()?>assets/admin/img/logo/logobizz.png" alt="logo">
                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="100%" valign="top" style="color: #FFFFFF" align="center">
                                                   ...
                                                   <span style="color: #FFF; font-size: 13px; ">Copyright ©2015 All Rights Reserved</span>
                                                </td>
