    ...
    <div class="page-content">
        ...
        <div class="search-page search-content-4">
			...
			.table-responsive .row
			{
				...
				<table class="table table-bordered table-striped dt-responsive" id="updates_services_requests">
                    <thead class="bg-blue">
                        <tr>
                        	<th><a href="javascript:;">Service</a></th>
                            <th><a href="javascript:;">Description</a></th>
                            <th><a href="javascript:;">No. of Quotes received</a></th>
                            <!--<th><a href="javascript:;">Attachment</a></th>-->
                            <th><a href="javascript:;">Duration</a></th>
                        </tr>
                    </thead>
                    <tbody>
					<?php
                    ...
                    ?>
                        <tr class="gradeX">
                        	<td class="table-title font-blue">
                            	<a href="<?php echo base_url();?>single_request_quotes/<?php echo $this->encrypt_model->encode($report['id'])?>"><?php echo $this->General_model->get_value_by_id('services', $report['service_id'], 'name');?></a>
                            </td>
                        ...
                        <table class="table table-bordered table-striped" >
                          <tr>
                              <td colspan="4" align="center" id="more_services_requests<?php echo $msg_id; ?>" class="morebox_services_requests">
                                  <a href="javacript:;" id="<?php echo $msg_id; ?>" onclick="more_rows_services_requests(<?php echo $msg_id; ?>)" class="more_services_requests">
                                      Show more
                                  </a>
                              </td>
                          </tr>
...
function more_rows_services_requests(ID) 
{
	if(ID)
	{
		...
		$.ajax({
			...
			var oTable = $('#updates_services_requests').dataTable({
				"bPaginate": false,
				"bInfo": false,
				"language": {
					"aria": {
