...
App.Scripts = {
	...
	plugins_dependency: [
		...
		'<?php echo base_url()?>assets_v1/admin/css/components/bootstrap-timepicker.js',
		'<?php echo base_url()?>assets_v1/admin/css/components/bootstrap-datepicker.js',
	...
	bundle: [
		'<?php echo base_url()?>assets_v1/admin/css/components/bootstrap-datepicker.init.js',
		...
		<div class="col-separator col-unscrollable box">
			...
			<div class="col-table">
						...
						<div class="col-app">
							<div class="login">
								<div class="col-sm-4 col-sm-offset-4 text-center">
                                	<img src="<?php echo base_url()?>assets_v1/admin/images/logo/alia-logo.png" alt="photo">
                                </div>
                                ...
                                <div class="alert alert-primary jquery_val_error condoinactive">
                                    <!--<button type="button" class="close" data-dismiss="alert">×</button>-->
                                    Your condo is not active anymore.
                                </div>
                ...
                <div id="success-message" class="form-hide">
                      ...
                      <div>
                        <a href="<?php echo base_url()?>security" class="btn btn-inverse btn-stroke btn-block">Back to login</a>
