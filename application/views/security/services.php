                                                            ...
                                                            <form method="post">
                                                                <div class="widget-body innerAll inner-2x">
                                                                  ...
                                                                  ?>
																		   ...
																		   {
																		   ?>
                                                                           <h2 class="pull-left"  style="padding: 10px 0 0 20px; width: 100%;"><?php echo $service_category['name'];?></h2>
                                                                           <br />
                                                                           <br />
                                                                           <div class="row">
																			   <select  multiple="multiple" class="my-select" name="category_<?php echo $service_category['id'];?>[]">
																			   <?php
																		   foreach($servies as $service)
																		   {
																		   ?>
                                                                             
                                                                                <option data-img-src="<?php echo base_url();?>uploads/service_categories/<?php echo $service['image_url'];?>" <?php if(in_array($service['id'],$vn_ser_arr)){?> selected="selected" <?php }?> value="<?php echo $service['id'];?>"><?php echo $service['name'];?></option> 
