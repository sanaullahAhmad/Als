	...
	<div class="user-action pull-right menu-right-hidden-xs menu-left-hidden-xs">
		<div class="dropdown username hidden-xs pull-left">
			...
			<ul class="dropdown-menu pull-right">
				<li class="active"><a href="<?php echo base_url()?>resident/profile" class="glyphicons user"><i></i> Profile</a></li>
				<li><a href="<?php echo base_url()?>resident/change_password">Change Password</a></li>
				<li><a href="<?php echo base_url()?>resident/do_logout">Logout</a></li>
		    </ul>
		</div>
