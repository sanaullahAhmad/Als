...
App.Scripts = {
	...
	plugins: [
		...
		'<?php echo base_url()?>assets/admin/css/components/common/tables/datatables/assets/custom/js/DT_bootstrap.js?v=v1.9.6&sv=v0.0.1', 
	],
	...
	bundle: [
		...
		'<?php echo base_url()?>assets/admin/css/components/common/tables/datatables/assets/custom/js/datatables.init.js?v=v1.9.6&sv=v0.0.1',
...
<body class="scripts-async menu-right-hidden">
	...
	<div class="container-fluid menu-hidden">
				...
				<!-- Main Sidebar Menu -->
		<?php //$this->load->view('resident/template/sidebar');?>
		...
		<div id="content">
			...
			<?php //$this->load->view('resident/template/header');?>
            <!--Header-->
		...
		<!-- Footer -->
		<?php $this->load->view('resident/template/footer');?>
		<!-- // Footer END -->
	</div>
