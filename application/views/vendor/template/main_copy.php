...
<!-- BEGIN CORE PLUGINS -->
        ...
        <script src="<?php echo base_url()?>assets/front/layouts/layout2/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>assets/front/layouts/layout2/scripts/demo.min.js" type="text/javascript"></script>
